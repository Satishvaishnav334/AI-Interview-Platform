  ...
  questions: [
      ...
      faceExpressions: [
        {
          ...
          timeStamp: Date.now(), // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 5000, // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 10000, // 5 seconds into the question
        },
        {
          expressionState: "confident",
          timeStamp: Date.now() + 15000, // 5 seconds into the question
        },
      ],
      gazeTracking: [
        {
      ...
      faceExpressions: [
        {
          ...
          timeStamp: Date.now() + 7000, // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 8000, // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 9000, // 5 seconds into the question
        },
        {
          expressionState: "focused",
          timeStamp: Date.now() + 55000, // 5 seconds into the question
        },
      ],
      gazeTracking: [
        {
    ...
    },
    {
      ...
      faceExpressions: [
        {
          expressionState: "focused",
          timeStamp: Date.now() + 25000, // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 35000, // 5 seconds into the question
        },
        {
          expressionState: "neutral",
          timeStamp: Date.now() + 40000, // 5 seconds into the question
        },
        {
          expressionState: "focused",
          timeStamp: Date.now() + 45000, // 5 seconds into the question
        },
      ],
      gazeTracking: [
        {
